...
<section id="formulario">
    <form action="/financial/controllers/adc_entrada_controller.php" method="post" autocomplete="off">
        <h1 class="form-item">Entrada</h1>

        <div class="form-item">
            <label for="nome_entrada">Titulo</label>
            <input type="text" name="nome_entrada" id="nome_entrada">
        </div>
